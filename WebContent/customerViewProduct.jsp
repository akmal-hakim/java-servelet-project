  ...
  <table id="tabel2">
		...
		<c:forEach items="${productList}" var="prod">
			<tr>
				...
				<td>	
					<c:choose>
						<c:when test="${prod.productCount > 0}">
							<c:out value="${prod.productCount}"/>
						</c:when>
						<c:otherwise>
							out of stock
						</c:otherwise>
				...
				<td>
					<c:if test="${prod.productCount ne 0 }">
					<a href="CustomerBuyProductController?productid=<c:out value="${prod.productID}"/>">Buy Now</a>
					</c:if>
					<a href="CustomerViewReviewProductController?productid=<c:out value="${prod.productID}"/>">View Review</a>
				</td>
