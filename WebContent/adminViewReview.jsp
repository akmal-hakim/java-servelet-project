  ...
  <table id="tabel2">
		...
		<c:forEach items="${reviewList}" var="review">
			<tr>
				...
				<td><c:out value="${review.reviewStar}"/></td>
				<td><c:out value="${review.reviewText}"/></td>
				<td><c:out value="${review.paymentDate}"/></td>
				<td><c:out value="${review.customerEmail}"/></td>
				<td>
					<a href="UpdateReviewController?action=updater&review_id=<c:out value="${review.reviewID}"/>">Update</a>
					<a href="deleteReviewController?action=delete&review_id=<c:out value="${review.reviewID}"/>">Delete</a>
				</td>
			</tr>
		</c:forEach>
	</table>
