...
<a href="adminCreateAccount.jsp" class="w3-button w3-block w3-white w3-left-align">Create admin</a>
...
<form action="AdminCreateAccountController" method="POST">
 <label for="Name">Admin Name:</label><br>
 <input type="text" name="admin_name" required><br>
 <label for="Name">Admin Username:</label><br>
